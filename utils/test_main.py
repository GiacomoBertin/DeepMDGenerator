...
import utils.deep_utility as dpu
import torch
...
class VampnetTools(object):
    ...
    def loss_VAMP2_autograd(self, y_torch, y_pred):
    ...
    def _inv(self, x, ret_sqrt=False):
        ...
        index_eig = int(eigval_all > eig_th)
...
pos = np.random.random((100, 6))
vamp = VampnetTools()
loss = vamp.loss_VAMP2_autograd(None, tf.convert_to_tensor(pos))
loss_my = dpu.loss_VAMP2_autograd(torch.tensor(pos))
print(loss, loss_my)
